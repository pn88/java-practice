...
public class LookupTableComparison
{
    ...
    {
        runLookups(new com.pinodev.collections.maps.before.MapProductLookupTable());
        runLookups(new com.pinodev.collections.maps.before.NaiveProductLookupTable());
    }
    ...
    private static void runLookups(final com.pinodev.collections.maps.before.ProductLookupTable lookupTable)
    {
